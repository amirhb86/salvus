...
MatrixXd TetrahedraNew<ConcreteShape>::mGradientOperator;
template <typename ConcreteShape>
VectorXd TetrahedraNew<ConcreteShape>::mIntegrationWeights;
template <typename ConcreteShape>
VectorXd TetrahedraNew<ConcreteShape>::mIntegrationCoordinates_r;
template <typename ConcreteShape>
VectorXd TetrahedraNew<ConcreteShape>::mIntegrationCoordinates_s;
template <typename ConcreteShape>
VectorXd TetrahedraNew<ConcreteShape>::mIntegrationCoordinates_t;
template <typename ConcreteShape>
MatrixXd TetrahedraNew<ConcreteShape>::mGradientPhi_dr;
template <typename ConcreteShape>
MatrixXd TetrahedraNew<ConcreteShape>::mGradientPhi_ds;
template <typename ConcreteShape>
MatrixXd TetrahedraNew<ConcreteShape>::mGradientPhi_dt;

std::vector<int> getVertsFromPoint(int point, int numVerts, DM &distributed_mesh);

template <typename ConcreteShape>
std::tuple<VectorXd,VectorXd,VectorXd> TetrahedraNew<ConcreteShape>::QuadraturePoints(const int order) {
...
template <typename ConcreteShape>
VectorXd TetrahedraNew<ConcreteShape>::QuadratureIntegrationWeights(const int order) {
...
template <typename ConcreteShape>
VectorXi TetrahedraNew<ConcreteShape>::ClosureMapping(const int order, const int dimension,
                                           DM &distributed_mesh) {
...
template <typename ConcreteShape>
TetrahedraNew<ConcreteShape>::TetrahedraNew(Options options) {
  ...
  std::tie(mIntegrationCoordinates_r,mIntegrationCoordinates_s,mIntegrationCoordinates_t) =
    TetrahedraNew<ConcreteShape>::QuadraturePoints(options.PolynomialOrder());        
  mIntegrationWeights = TetrahedraNew<ConcreteShape>::QuadratureIntegrationWeights(options.PolynomialOrder());
...
template <typename ConcreteShape>
void TetrahedraNew<ConcreteShape>::attachVertexCoordinates(DM &distributed_mesh) {
...
template <typename ConcreteShape>
VectorXd TetrahedraNew<ConcreteShape>::ParAtIntPts(const std::string &par) {
...
template <typename ConcreteShape>
void TetrahedraNew<ConcreteShape>::attachMaterialProperties(const ExodusModel *model, std::string parameter_name) {
...
template <typename ConcreteShape>
void TetrahedraNew<ConcreteShape>::attachSource(std::vector<std::shared_ptr<Source>> sources) {
...
template <typename ConcreteShape>
MatrixXd TetrahedraNew<ConcreteShape>::computeGradient(const Ref<const VectorXd>& field) {
...
template <typename ConcreteShape>
VectorXd TetrahedraNew<ConcreteShape>::applyGradTestAndIntegrate(const Ref<const MatrixXd>& f) {
...
template <typename ConcreteShape>
MatrixXd TetrahedraNew<ConcreteShape>::buildStiffnessMatrix(VectorXd velocity) {
...
template <typename ConcreteShape>
void TetrahedraNew<ConcreteShape>::setupGradientOperator() {
...
template <typename ConcreteShape>
void TetrahedraNew<ConcreteShape>::attachReceiver(std::vector<std::shared_ptr<Receiver>> &receivers) {
  printf("TODO: attachedReciever\n");
  exit(1);
}

template <typename ConcreteShape>
VectorXd TetrahedraNew<ConcreteShape>::applyTestAndIntegrate(const Ref<const VectorXd> &f) {
...
template <typename ConcreteShape>
void TetrahedraNew<ConcreteShape>::setBoundaryConditions(Mesh *mesh) {
  mBndElm = false;
...
template <typename ConcreteShape>
void TetrahedraNew<ConcreteShape>::applyDirichletBoundaries(Mesh *mesh, Options &options, const std::string &fieldname) {
...
template class TetrahedraNew<TetP1>;
