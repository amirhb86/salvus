...
class ElementAdapter: public ElementNew, public T {
   ...
   *
   * \brief Class which serves to delegate the abstract ElementNew class to concrete implementations.
   *
   * This class serves as a bridge between the abstract interface defined in ElementNew, and the generic
   ...
   * to a finite element of that type. Since this type also inherits from the interface class ElementNew,
