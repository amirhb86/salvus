...
void closure_mapping_order3_square(int *out_1434872603480458915);
void gll_weights_order3_square(double *out_8586666373437537841);
void gll_coordinates_order3_square(double *out_6407435751412178427);
