...
HexahedraNew<ConcreteHex>::HexahedraNew(Options options) {
  ...
  // Integration points.
  mIntCrdR = HexahedraNew<ConcreteHex>::GllPoints(mPlyOrd);
  mIntCrdS = HexahedraNew<ConcreteHex>::GllPoints(mPlyOrd);
  mIntCrdT = HexahedraNew<ConcreteHex>::GllPoints(mPlyOrd);
  mIntWgtR = HexahedraNew<ConcreteHex>::GllIntegrationWeights(mPlyOrd);
  mIntWgtS = HexahedraNew<ConcreteHex>::GllIntegrationWeights(mPlyOrd);
  mIntWgtT = HexahedraNew<ConcreteHex>::GllIntegrationWeights(mPlyOrd);
  ...
  mGrd = HexahedraNew<ConcreteHex>::setupGradientOperator(mPlyOrd);
...
template <typename ConcreteHex>
VectorXi HexahedraNew<ConcreteHex>::ClosureMapping(int order, int elem_num, DM &distributed_mesh) {
  if( order == 3) {
...
template <typename ConcreteHex>
VectorXd HexahedraNew<ConcreteHex>::GllPoints(const int order) {
...
template <typename ConcreteHex>
VectorXd HexahedraNew<ConcreteHex>::GllIntegrationWeights(const int order) {
...
template <typename ConcreteHex>
VectorXd HexahedraNew<ConcreteHex>::rVectorStride(const Eigen::Ref<const Eigen::VectorXd>& f,
...
template <typename ConcreteHex>
VectorXd HexahedraNew<ConcreteHex>::sVectorStride(const Eigen::Ref<const Eigen::VectorXd>& f,
...
template <typename ConcreteHex>
VectorXd HexahedraNew<ConcreteHex>::tVectorStride(const Eigen::Ref<const Eigen::VectorXd>& f,
...
template <typename ConcreteHex>
void HexahedraNew<ConcreteHex>::attachVertexCoordinates(DM &distributed_mesh) {
...
template <typename ConcreteHex>
void HexahedraNew<ConcreteHex>::attachMaterialProperties(const ExodusModel *model,std::string parameter_name) {
...
template <typename ConcreteHex>
void HexahedraNew<ConcreteHex>::attachReceiver(std::vector<std::shared_ptr<Receiver>> &receivers) {
...
template <typename ConcreteHex>
void HexahedraNew<ConcreteHex>::attachSource(std::vector<std::shared_ptr<Source>> sources) {
...
template <typename ConcreteHex>
VectorXd HexahedraNew<ConcreteHex>::getDeltaFunctionCoefficients(const double r, const double s, const double t) {
...
template <typename ConcreteHex>
VectorXd HexahedraNew<ConcreteHex>::interpolateLagrangePolynomials(const double r,
                                                                   const double s,
                                                                   const double t,
                                                                   const int order)
...
template <typename ConcreteHex>
MatrixXd HexahedraNew<ConcreteHex>::setupGradientOperator(const int order) {

  auto rn = HexahedraNew<ConcreteHex>::GllPoints(order);
...
template <typename ConcreteHex>
VectorXd HexahedraNew<ConcreteHex>::ParAtIntPts(const std::string &par) {
...
template <typename ConcreteHex>
VectorXd HexahedraNew<ConcreteHex>::applyTestAndIntegrate(const Ref<const VectorXd> &f) {
...
template <typename ConcreteHex>
VectorXd HexahedraNew<ConcreteHex>::applyGradTestAndIntegrate(const Ref<const MatrixXd> &f) {
...
template <typename ConcreteHex>
double HexahedraNew<ConcreteHex>::integrateField(const Eigen::Ref<const Eigen::VectorXd> &field) {
...
template <typename ConcreteHex>
void HexahedraNew<ConcreteHex>::setBoundaryConditions(Mesh *mesh) {
  mBndElm = false;
...
template <typename ConcreteHex>
void HexahedraNew<ConcreteHex>::applyDirichletBoundaries(Mesh *mesh, Options &options, const std::string &fieldname) {
...
template class HexahedraNew<HexP1>;
